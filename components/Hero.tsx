...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-black">
      ...
      {/* Content Layer - Constrained Width & Optimized Font Size */}
      <div className="relative z-20 h-full flex flex-col justify-center items-center text-center px-6 pointer-events-none">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {slide.title && (
              <h1
                className="text-white font-bold mb-6 drop-shadow-[0_4px_8px_rgba(0,0,0,0.9)] leading-tight tracking-tight"
            ...
            <motion.button
              ...
              className="bg-cuhk-secondary text-white px-10 py-3 tracking-widest text-xs font-bold transition-all duration-300 shadow-2xl uppercase pointer-events-auto"
            >
              {t("hero.button")}
            </motion.button>
          </motion.div>
      ...
      <motion.div
        ...
        className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-white flex flex-col items-center cursor-pointer hover:text-cuhk-secondary transition-colors z-30 pointer-events-auto"
        onClick={handleScrollDown}
      >
        <span className="text-[10px] uppercase tracking-[0.3em] mb-1 font-medium">
          {t("hero.scroll")}
        </span>
        <ChevronDown size={20} />
      </motion.div>
